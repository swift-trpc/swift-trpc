#
#  Be sure to run `pod spec lint swift-trpc.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "swift-trpc"
  spec.version      = "0.0.1"
  spec.summary      = "A quick and easy way to get your tRPC API work in Swift environment"
